package com.kolly.learning.javacollection;
...
public class LRUCacheDemo2 {
     ...
     */
    static class LRU<K, V> implements Iterable<LRU.Node> {
        ...
        @Override
        public Iterator<LRU.Node> iterator() {

            return new Iterator<LRU.Node>() {
